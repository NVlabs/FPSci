...
* `symmetricEcc` is a boolean flag indicating whether the target spawn eccentricities are to be considered in all 4 directions or not
...
targets = [
    {
        ...
        "symmetricEcc" : false;                 // Target will only spawn on one quadrant according to eccH/V signs
