...
char* vString = "Hardware Event Logger (FW Rev 3.0)";      // Version print string
...
SIGNAL(TIMER0_COMPA_vect){
    if(!clickOut) digitalWrite(clickPin, LOW);     // Get rid of the click for good
        ...
        if(mouseCount >= MAX_MOUSE_DOWN_MS){
            ...
            digitalWrite(clickPin, LOW);    // Set the mouse in the "up" state
