...
if __name__ == '__main__':
    ...
    try:
        ...
        sys.stderr.write('No %s found, continuing without it.\n'%(inputLog))
    else:
        with log:
            sys.stderr.write('Adding files from %s to %s.\n'%(inputLog, outputScript))
    ...
    with open(outputScript, 'w') as packageScript:
        sys.stderr.write('Writing updated script to ' + outputScript + '.\n')
    ...
    with open('README.txt', 'w') as readmeFile:
        sys.stderr.write('Writing generated readme to README.txt.\n')
