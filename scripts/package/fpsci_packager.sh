#!/bin/bash
# Autogenerated 2022 08 31 10:56:55
mkdir -p dist/sound/
...
mkdir -p dist/
cp vs/Build/FirstPersonScienceServer-x64-Release/FirstPersonScienceServer.exe dist/
cp vs/Build/FirstPersonScience-x64-Release/FirstPersonScience.exe dist/
cp data-files/g3d-license.txt dist/
cp README.txt dist/
cp LICENSE.txt dist/
cp ./data-files/userstatus.Any dist/
cp ./data-files/userconfig.Any dist/
cp ./data-files/startupconfig.Any dist/
...
cp ./data-files/serverstartupconfig.Any dist/
...
cp ./data-files/experimentconfig.Any dist/
