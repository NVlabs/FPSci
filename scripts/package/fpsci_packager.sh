#!/bin/bash
# Autogenerated 2023 04 14 10:35:59
mkdir -p dist/sound/
...
cp $g3d/G3D10/data-files/shader/UniversalSurface/UniversalSurface_vertexOutputs.glsl dist/shader/UniversalSurface/
...
cp $g3d/G3D10/data-files/shader/UniversalSurface/UniversalSurface_fragmentInputs.glsl dist/shader/UniversalSurface/
